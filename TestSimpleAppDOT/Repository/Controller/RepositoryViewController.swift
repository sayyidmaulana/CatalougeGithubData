...
class RepositoryViewController: UITableViewController {
    ...
    lazy var titleStackView: UIStackView = {
        ...
        subtitleLabel.text = "List of the Repo"
    ...
    private func setupView() {
        ...
        tableView.register(RepositoryViewCell.self, forCellReuseIdentifier: reuseIndentifier)
    ...
    private func checkRepo() {
        ...
        URLSession.shared.dataTask(with: request) { (data, response, error) in
            ...
            do {
                ...
                let JSONData = try JSONDecoder().decode(Repository.self, from: data)
                
                self.repoList = JSONData.items
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: reuseIndentifier, for: indexPath) as! RepositoryViewCell
        cell.label.text = repoList[indexPath.row].fullName 
        return cell
    }
