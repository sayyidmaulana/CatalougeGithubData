...
enum Title: String, Codable {
    case a = "a"
    case editedAFileCreatedAFile = "edited a file, created a file"
    case titleA = "A"
}
...
enum TypeEnumIssues: String, Codable {
    case user = "User"
}
